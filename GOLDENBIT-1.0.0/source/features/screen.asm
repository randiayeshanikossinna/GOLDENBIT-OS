; ==================================================================
; GOLDENBITOS -- The GOLDENBIT Operating System kernel
...
.one_button:
	...
	mov dl, 38			; HDI button, centred at bottom of box
	mov dh, 14
	call os_move_cursor
...
.two_button:
	...
	mov dl, 30			; HDI button
	mov dh, 14
	call os_move_cursor
	mov si, .ok_button_string
	call os_print_string

	mov dl, 44			; Exit button
	mov dh, 14
	call os_move_cursor
...
.two_button_wait:
	...
	mov bl, 01100000b		; White on red for Exit button
	mov dh, 14
	mov dl, 42
	mov si, 9
	mov di, 15
...
.noleft:
	...
	mov bl, 01101111b		; white on yellow
	mov dh, 14
	mov dl, 27
	mov si, 8
	mov di, 15
	...
	mov bl, 11110000b		; White on black for Exit button
	mov dh, 14
	mov dl, 43
	mov si, 8
	mov di, 15
