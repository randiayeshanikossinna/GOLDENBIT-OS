; ==================================================================
;    GOLDENBIT OS -- The GOLDENBIT Operating System kernel
; ==================================================================


	BITS 16

	%DEFINE GOLDENBITOS_VER '1.0.0'	; OS version number
	%DEFINE GOLDENBITOS_API_VER 17	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as GOLDENBITOS and its programs
...
option_screen:
	...
	mov cx, 01101111b		; Colour: white text on Brown
	...
	jne near os_draw_background1

call os_exit		; Otherwise clean screen and start the CLI
	

	; Data for the above code...
	os_init_msg		db '                      <---Welcome to GOLDENBIT OS--->', 0
	os_version_msg		db 'Version ', GOLDENBITOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', GOLDENBITOS_VER, 0

	dialog_string_1		db 'Welcome to GOLDENBIT Operating System.', 0
	dialog_string_2		db 'Please select HDI for HardwareInfo or', 0
	dialog_string_3		db 'select Exit to quit the OS.', 0
